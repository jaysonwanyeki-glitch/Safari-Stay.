...
export const MAJOR_STAGES: MajorStage[] = [
  ...
  { town: "Garissa", county: "Garissa", stage: "Garissa town stage", routes: "Nairobi (via Thika–Garissa Hwy), Dadaab, the north-eastern frontier", operators: ["Tawakal Express", "Rhamu Express", "Garissa shuttles"], fare: "≈ KES 2,000–3,000 from Nairobi" },
